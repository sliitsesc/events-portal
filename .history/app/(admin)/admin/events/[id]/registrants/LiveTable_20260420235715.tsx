            ...
            <thead className="bg-muted/60">
              <tr className="text-left">
                ...
                {eventType === "industry_visit" && (
                  <>
                    <th className="px-4 py-2 font-medium text-orange-700 dark:text-orange-400">NIC Number</th>
                    <th className="px-4 py-2 font-medium text-orange-700 dark:text-orange-400">Phone</th>
                  </>
                )}
