...
export function EventRegistrationSection({
      ...
      return (
        <div className="flex flex-col gap-4 rounded-lg border bg-orange-50/50 dark:bg-orange-950/20 p-4 border-orange-100 dark:border-orange-900/50">
          <div className="flex flex-col gap-1">
            <h3 className="font-semibold text-orange-900 dark:text-orange-500">Security Verification Required</h3>
          ...
          <Button onClick={onRegister} disabled={isPending} className="mt-2 w-full sm:w-auto self-start bg-orange-600 hover:bg-orange-700 text-white">
            {isPending ? "Validating & Securing Spot..." : "Verify Identity & Register"}
          </Button>
  ...
  return (
    <div className="flex flex-col gap-4">
      <Button onClick={onRegister} disabled={isPending} className="w-full sm:w-auto self-start">
        {isPending
