      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-5 py-10 md:gap-14 md:py-14">
          ...
          <div className="relative grid items-center gap-8 md:grid-cols-[1.1fr_0.9fr]">
            <div className="flex flex-col gap-5">
              ...
              <p className="max-w-xl text-base text-muted-foreground md:text-lg">
                ...
                check-in. One clean flow for students and organizers.
              </p>
        ...
        <section className="grid gap-4 md:grid-cols-2">
          ...
          <article className="rounded-2xl border bg-card p-6">
            ...
            <h2 className="mt-2 text-2xl font-bold tracking-tight">
              Launch Events Without Friction
            </h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Publish events, manage registrants, and track attendance from one
              admin workspace.
            </p>
            <div className="mt-5 flex gap-3">
              <Link
        ...
        <section className="rounded-2xl border bg-card p-6 md:p-8">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-3">
            <div className="rounded-lg border bg-background p-4">
              <p className="text-sm font-semibold">1. Publish Event</p>
              <p className="mt-1 text-sm text-muted-foreground">
                Create event details with schedule, format, and capacity.
              </p>
            </div>
            <div className="rounded-lg border bg-background p-4">
              <p className="text-sm font-semibold">2. Fill Seats</p>
              <p className="mt-1 text-sm text-muted-foreground">
                Students register online and receive ticket confirmation.
              </p>
            </div>
            <div className="rounded-lg border bg-background p-4">
              <p className="text-sm font-semibold">3. Check In</p>
              <p className="mt-1 text-sm text-muted-foreground">
                Validate attendance quickly with the admin attendance flow.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="flex flex-col items-start justify-between gap-5 md:flex-row md:items-center">
            <div>
              <h2 className="text-2xl font-bold tracking-tight">
                Make Your Next Campus Event Easier To Run.
              </h2>
              <p className="mt-2 max-w-2xl text-sm text-background/80">
                The best event platforms remove friction. Start with your next
                event and let students self-serve registration and tickets.
              </p>
            </div>
        ...
        <section className="rounded-2xl border bg-card p-5">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            Access control and profile verification are enabled for protected
